/* 
webCom:/alidata/www/single_shop/components/layout/astro/astro.js is miss */


/* unCombined: */
/* jsCom:qrcodealg,qrcode */ 

/* /alidata/www/single_shop/assets/jslib/qrcodealg/qrcodealg.js */
/**
 * qrcode 
 * @author: luxin
 * @date: 2015/3/13
...
Mo.define('qrcodealg', function (M) {
/**
 * 获取单个字符的utf8编码
...
function QRCodeAlg(data, errorCorrectLevel) {
	...
	var self = this;
	if(!(M.instanceOf(self, QRCodeAlg))) {
        self = new QRCodeAlg(data, errorCorrectLevel);
    }else{
        self.init(data, errorCorrectLevel);
    }
}

M.extend(QRCodeAlg, {
	//初始化
	init: function(data,errorCorrectLevel){
...
M.QRCodeAlg = QRCodeAlg;
});


/* /alidata/www/single_shop/assets/jslib/qrcode/qrcode.js */
//@require qrcodealg
/**
 * qrcode 
 * @author: luxin
...
/* /alidata/www/single_shop/pages/astro/astro-map/astro-map.js */
//@require qrcode
Mo.ready(function(M) {
